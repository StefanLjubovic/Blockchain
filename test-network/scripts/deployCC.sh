...
for i in 0 1 2 3
do
	infoln "Install chaincode org1 peer${i} to the channel..."
	installChaincode 1 $peerPort ${i}
  	peerPort=$(($peerPort + 100))

done

infoln "Joining org2 peer0 to the channel..."
installChaincode 2 9051 0
infoln "Joining org3 peer0 to the channel..."
installChaincode 3 11051 0
infoln "Joining org4 peer0 to the channel..."
installChaincode 4 13051 0
...
for i in 0 1 2 3
do
	infoln "Query wether the chaincode is installed: org1 peer${i}"
	queryInstalled 1 $peerPort ${i}
  	peerPort=$(($peerPort + 100))
...
approveForMyOrg 1 7051 0
## check whether the chaincode definition is ready to be committed
## expect org1 to have approved and org2 not to

##checkCommitReadiness 1 7051 0"\"Org1MSP\": true" "\"Org2MSP\": false" "\"Org3MSP\": false" 
##checkCommitReadiness 2 9051 0"\"Org1MSP\": true" "\"Org2MSP\": false" "\"Org3MSP\": false" 
##checkCommitReadiness 3 11051 0"\"Org1MSP\": true" "\"Org2MSP\": false" "\"Org3MSP\": false" 

## now approve also for org2
approveForMyOrg 2 9051 0

## check whether the chaincode definition is ready to be committed
## expect them both to have approved and org3 not to
##checkCommitReadiness 1 7051 0"\"Org1MSP\": true" "\"Org2MSP\": true" "\"Org3MSP\": false" 
##checkCommitReadiness 2 9051 0"\"Org1MSP\": true" "\"Org2MSP\": true" "\"Org3MSP\": false" 
##checkCommitReadiness 3 11051 0"\"Org1MSP\": true" "\"Org2MSP\": true" "\"Org3MSP\": false" 

## now approve also for org3
approveForMyOrg 3 11051 0

approveForMyOrg 4 13051 0
## check whether the chaincode definition is ready to be committed
...
for i in 0 1 2 3
do
	queryCommited 1 $peerPort ${i}
  	peerPort=$(($peerPort + 100))

done
queryCommitted 2 9051 0
queryCommitted 3 11051 0
queryCommitted 4 13051 0
